			...
			<div className="container mt-5 d-flex flex-column justify-content-center align-items-center">
				...
				{isLoading ? (
					...
					<div className="col-md-6 mt-4 mb-5">
						...
						<p>이름: {bookingInfo.guestName}</p>
						<p>이메일: {bookingInfo.guestEmail}</p>
						<p>성인: {bookingInfo.numOfAdults}</p>
						<p>아이: {bookingInfo.numOfChildren}</p>
						<p>총 인원: {bookingInfo.totalNumOfGuests}</p>
